...
export class CreateOrganizationDto {
  ...
  @ApiProperty({
    example: 'CORPA',
    description: 'Unique registration code used by employees during signup',
  })
  @IsString()
  @IsNotEmpty()
  code: string;
  ...
  @ApiPropertyOptional({
    example: 'https://logo.url/logo.png',
  ...
  @ApiProperty({
    ...
    description: 'Street address of the organization headquarters',
  })
  @IsString()
  @IsNotEmpty()
  address: string;
