...
import { IsNotEmpty, IsString, IsInt, Min, Max, IsOptional, IsDateString } from 'class-validator';

export class CreateVehicleDto {
  @ApiProperty({ example: 'Honda', description: 'The manufacturer of the vehicle' })
  @IsString()
  @IsNotEmpty()
  manufacturer: string;
  ...
  @ApiProperty({ example: 'MH-12-XX-1234', description: 'Unique vehicle registration number' })
  @IsString()
  @IsNotEmpty()
  registrationNumber: string;

  @ApiProperty({ example: 4, description: 'Seating capacity (excluding driver)' })
  @IsInt()
  @Min(1)
  @Max(8)
