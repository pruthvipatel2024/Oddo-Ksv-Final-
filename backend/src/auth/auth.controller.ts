...
export class AuthController {
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new employee account under a specific organization using its invite code and provisions a wallet.',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiResponse({
    status: 400,
    description: 'Invalid data or organization code.',
  })
  @ApiResponse({
    status: 409,
  ...
  @ApiOperation({
    summary: 'Employee / Administrator Login',
    description:
      'Authenticates credentials and issues a JWT access and refresh token set.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    status: 401,
    description: 'Invalid login credentials or suspended account.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Exchanges a valid refresh token for a brand new access and refresh token set.',
  })
