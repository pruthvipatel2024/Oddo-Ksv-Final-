...
export class SearchRideDto {
  ...
  @ApiProperty({
    example: 1,
    description: 'Number of passenger seats needed',
    required: false,
  })
  @IsInt()
  @Min(1)
  ...
  @ApiProperty({
    example: 2000,
    description: 'Pickup detour radius in meters',
    required: false,
  })
  @IsNumber()
  @Type(() => Number)
  ...
  @ApiProperty({
    example: 2000,
    description: 'Destination detour radius in meters',
    required: false,
  })
  @IsNumber()
  @Type(() => Number)
  ...
  @ApiProperty({
    example: 30,
    description: 'Departure time buffer window in minutes',
    required: false,
  })
  @IsInt()
  @Type(() => Number)
  ...
  @ApiProperty({
    example: 4.0,
    description: 'Minimum driver rating filter',
    required: false,
  })
  @IsNumber()
  @Type(() => Number)
  ...
  @ApiProperty({
    example: 'Sedan',
    description: 'Vehicle type/category filter',
    required: false,
  })
  @IsString()
  @IsOptional()
