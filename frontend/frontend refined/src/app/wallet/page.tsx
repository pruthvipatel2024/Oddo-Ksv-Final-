  ...
  return (
    <AppShell title="Wallet">
      <div className="mx-auto max-w-xl">
        <Card className="mb-5 flex items-center justify-between bg-gradient-to-r from-teal-500 to-teal-600 p-6 text-white">
          <div>
        ...
        {step === "success" ? (
          <Card className="flex flex-col items-center gap-3 p-10 text-center">
            ...
            <p className="text-sm text-ink-500 dark:text-ink-400">
              New balance: <span className="font-mono font-semibold text-ink-700 dark:text-ink-200">₹{120 + amount}</span>
            </p>
          ...
          <Card className="p-6">
            ...
            <p className="mb-5 text-sm text-ink-400">Step 1 — amount, Step 2 — payment method &amp; details.</p>

            <form className="flex flex-col gap-5" onSubmit={handlePay}>
              {/* Step 1: amount */}
              <div>
                <Input label="Amount" type="number" min={50} value={amount} onChange={(e) => setAmount(Number(e.target.value))} />
                ...
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                  {methods.map((m) => (
                    ...
                    >
                      ...
                      <p className="text-ink-400">{m.hint}</p>
                    </button>
                  ))}
                </div>
              </div>
                ...
                <div className="flex flex-col gap-4 rounded-xl border border-ink-100 p-4 dark:border-ink-800">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-sm">
                      ...
                      <p className="font-mono font-semibold text-ink-800 dark:text-ink-100">RidesFare@ABCD</p>
              ...
              <Button type="submit" className="w-full" size="lg">
                {method === "cash" ? "Generate Reference Code" : `Add ₹${amount}`}
              </Button>
