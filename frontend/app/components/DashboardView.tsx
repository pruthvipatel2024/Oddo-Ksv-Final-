...
type BookingStep = "find-ride" | "confirm-route" | "available-rides" | "track-ride" | "trip-finish" | "payment-method";
...
export const DashboardView: React.FC<DashboardViewProps> = ({ onLogout }) => {
  ...
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    if (newMessage.trim()) {
      ...
      setNewMessage("");
      // Simulated driver auto-response after 1s
      setTimeout(() => {
        setChatMessages((prev) => [
          ...prev,
  ...
  const handleFinalPayment = () => {
    ...
    // Add to logs
    setWalletLogs((prev) => [
      { id: Date.now(), type: "Debit", desc: `Ride with ${selectedDriver.name} (Paid via ${payMethod.toUpperCase()})`, amount: 120, date: "18 Jul 2026" },
      ...prev
    ]);
      ...
      <header className="flex h-16 w-full items-center justify-between border-b border-zinc-100 bg-white px-6 shadow-sm shadow-zinc-100/30">
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-sans text-lg font-bold tracking-tight text-zinc-900 animate-[pulse_3s_infinite]">
              Carpooling
            </span>
          </div>
        ...
        <aside className="hidden w-48 flex-col justify-between border-r border-zinc-100 bg-zinc-50/50 p-6 md:flex">
          <div>
            ...
            <div className="mt-4 flex flex-col gap-1.5">
              <button
                onClick={() => { setActiveTab("dashboard"); setBookingStep("find-ride"); }}
                className={`flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-bold transition-all ${activeTab === "dashboard" ? "bg-indigo-600 text-white shadow-md shadow-indigo-200" : "text-zinc-600 hover:bg-zinc-100"
                  }`}
              >
              ...
              <button
                onClick={() => { setActiveTab("trips"); setTripsView("list"); }}
                className={`flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-bold transition-all ${activeTab === "trips" ? "bg-indigo-600 text-white shadow-md shadow-indigo-200" : "text-zinc-600 hover:bg-zinc-100"
                  }`}
              >
              ...
              <button
                onClick={() => { setActiveTab("wallet"); setWalletView("summary"); }}
                className={`flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-bold transition-all ${activeTab === "wallet" ? "bg-indigo-600 text-white shadow-md shadow-indigo-200" : "text-zinc-600 hover:bg-zinc-100"
                  }`}
              >
              ...
              <button
                onClick={() => setActiveTab("history")}
                className={`flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-bold transition-all ${activeTab === "history" ? "bg-indigo-600 text-white shadow-md shadow-indigo-200" : "text-zinc-600 hover:bg-zinc-100"
                  }`}
              >
              ...
              <button
                onClick={() => setActiveTab("settings")}
                className={`flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-bold transition-all ${activeTab === "settings" ? "bg-indigo-600 text-white shadow-md shadow-indigo-200" : "text-zinc-600 hover:bg-zinc-100"
                  }`}
              >
        ...
        <main className="flex-1 p-6 md:p-12">
          ...
          {activeTab === "dashboard" && (
            <div className="w-full max-w-5xl rounded-2xl border border-zinc-100 bg-white p-6 shadow-xl shadow-zinc-100/40">
              ...
              {/* STEP 1: FIND RIDE FORM */}
              {bookingStep === "find-ride" && (
                <div>
                  <div className="mb-6 flex gap-4">
                    <button className="flex-1 rounded-xl bg-zinc-900 py-3.5 text-sm font-bold text-white shadow-md transition-all">
                      Find Ride
                    </button>
                    <button className="flex-1 rounded-xl border border-zinc-200 bg-white py-3.5 text-sm font-bold text-zinc-500 hover:bg-zinc-50 transition-all">
                      Offer Ride
                    </button>
                  </div>
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                      ...
                      <div className="space-y-1">
                        <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider">Available Seats</label>
                        <div className="relative flex items-center">
                ...
                <div className="flex flex-col gap-6 lg:flex-row">
                  ...
                  <div className="relative flex-1 overflow-hidden rounded-xl border border-zinc-150 bg-sky-50 shadow-inner h-96">
                    <svg className="h-full w-full" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path d="M 220 0 Q 230 75 220 150 Q 210 225 220 300" stroke="#E0F2FE" strokeWidth="24" strokeLinecap="round" fill="none" />
                    ...
                    <div className="absolute bottom-4 right-4 rounded-xl bg-white p-3 border border-zinc-150 shadow-md">
                      <span className="block text-[10px] font-bold text-emerald-600 uppercase tracking-wide">Recommended</span>
                      <span className="text-sm font-extrabold text-zinc-800">33 min (26 km)</span>
                    </div>
                  </div>
                </div>
              )}
                    ...
                    {drivers.map((driver) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button className="flex h-10 w-10 items-center justify-center rounded-xl border border-zinc-200 bg-white text-zinc-400">
                  ...
                  <div className="mx-auto max-w-xl rounded-2xl border border-zinc-150 bg-white p-6 shadow-md">
                    <div className="flex items-center justify-between border-b border-zinc-100 pb-4 mb-5">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h3 className="font-bold text-zinc-900">{selectedDriver.name}</h3>
                          <span className="text-xs text-zinc-400">{selectedDriver.time}</span>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-8">
                      <div className="rounded-xl bg-zinc-50 p-4 border border-zinc-100 text-center">
              ...
              {bookingStep === "payment-method" && (
                <div>
                  ...
                  <div className="mx-auto max-w-2xl rounded-2xl border border-zinc-150 bg-white p-6 shadow-md md:flex gap-8">
                      ...
                      <div className={`rounded-xl border p-4 transition-all ${payMethod === "upi" ? "border-indigo-600 bg-indigo-50/20" : "border-zinc-200"
                        ...
                        {payMethod === "upi" && (
                          <div className="mt-3 flex gap-2">
                            ...
                            />
                            <button className="rounded-lg border border-zinc-200 bg-white px-3 py-1.5 text-xs font-bold text-zinc-600 hover:bg-zinc-50">
                              Scan
                            </button>
                          </div>
                        )}
                    ...
                    {/* Right QR visual representation */}
                    <div className="hidden w-48 flex-col items-center justify-center border-l border-zinc-100 pl-8 md:flex">
                      <div className="flex h-36 w-36 items-center justify-center rounded-xl border border-zinc-200 bg-white p-3 shadow-inner">
                        {/* Mock QR SVG */}
                        <svg className="h-full w-full text-zinc-800" viewBox="0 0 100 100" fill="none">
                          ...
                          <rect x="88" y="84" width="8" height="8" fill="currentColor" />
                          ...
                          <rect x="36" y="48" width="24" height="8" fill="currentColor" />
                          <rect x="64" y="36" width="12" height="24" fill="currentColor" />
                          <rect x="48" y="76" width="16" height="16" fill="currentColor" />
                          <rect x="72" y="68" width="16" height="8" fill="currentColor" />
                        </svg>
                      </div>
                      <span className="text-[9px] font-bold text-zinc-400 uppercase tracking-wider mt-3">Scan QR to Pay</span>
                    </div>
                  </div>
                  ...
                  <div className="mx-auto max-w-2xl mt-6">
                    <button
                      ...
                      className="w-full rounded-xl bg-indigo-600 py-4 text-sm font-semibold text-white hover:bg-indigo-700 transition-all text-center shadow-lg shadow-indigo-100"
                    >
          ...
          {activeTab === "trips" && (
            <div className="w-full max-w-4xl rounded-2xl border border-zinc-100 bg-white p-6 shadow-xl shadow-zinc-100/40">
              ...
              {tripsView === "list" && (
                <div>
                  <div className="mb-6">
                    <span className="text-xs tracking-wider uppercase font-bold text-indigo-500/80">Active Booking</span>
                    <h2 className="text-2xl font-bold tracking-tight text-zinc-900">My Trips</h2>
                  </div>

                  <div className="space-y-4">
                    {/* Active booked trip display */}
                    <div
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            <h3 className="font-extrabold text-zinc-800">Iskcon to Infocity</h3>
                          ...
                          <span className="text-xs text-zinc-500 block mt-1">
                            Driver: Raj Patel · Time: 07:00 PM 18/July/26
                          </span>
                        </div>
                      </div>
                    ...
                    <form onSubmit={handleRechargeWallet} className="flex-1 space-y-4">
                      ...
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          className="w-full rounded-xl border border-linear-light bg-white px-3.5 py-3 text-sm outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100/50 font-bold"
                          placeholder="₹ 500"
                        />
                      </div>
                      ...
                      <div className={`rounded-xl border p-4 transition-all ${rechargeMethod === "upi" ? "border-indigo-600 bg-indigo-50/20" : "border-zinc-200"
                        ...
                        {rechargeMethod === "upi" && (
                          <div className="mt-3 flex gap-2">
                            ...
                            />
                            <button type="button" className="rounded-lg border border-zinc-200 bg-white px-3 py-1.5 text-xs font-bold text-zinc-600 hover:bg-zinc-50">
                              Scan
                            </button>
                          </div>
                        )}
            ...
            <div className="w-full max-w-4xl rounded-2xl border border-zinc-100 bg-white p-6 shadow-xl shadow-zinc-100/40">
              ...
              <div className="space-y-4 max-w-xl">
                <div className="flex items-center justify-between py-3 border-b border-zinc-100">
                  <div>
                    <span className="font-semibold text-zinc-800 block text-sm">Push Notifications</span>
                    <span className="text-xs text-zinc-400">Receive real-time match signals</span>
                  </div>
                  <button className="h-6 w-11 rounded-full bg-indigo-600 relative">
                    <div className="absolute top-0.5 left-5.5 h-5 w-5 rounded-full bg-white shadow-sm" />
                  </button>
                </div>
                <div className="flex items-center justify-between py-3 border-b border-zinc-100">
                  <div>
                    <span className="font-semibold text-zinc-800 block text-sm">Safety SOS Sharing</span>
                    <span className="text-xs text-zinc-400">Auto-share active trips with emergency contact</span>
                  </div>
                  <button className="h-6 w-11 rounded-full bg-zinc-300 relative">
